  ...
  */ !function(t, e) {
    ...
    , a = (t, e, i)=>{
        Object.keys(i).forEach((n)=>{
            const s = i[n], r = e[n], a = r && o(r) ? "element" : null == (l = r) ? `${l}` : ({
    ...
    , g = (t)=>{
        ...
        let r = !1;
        const a = ({ target: n  })=>{
            n === i && (r = !0, i.removeEventListener(t1, a), _(e));
        };
        i.addEventListener(t1, a), setTimeout(()=>{
            r || s(i);
        }, o);
    }, v = (t, e, i, n)=>{
        let s = t.indexOf(e);
        ...
        _setActiveIndicatorElement(t) {
            if (this._indicatorsElement) {
                ...
                for(let e2 = 0; e2 < i.length; e2++)if (Number.parseInt(i[e2].getAttribute("data-bs-slide-to"), 10) === this._getItemIndex(t)) {
                    i[e2].classList.add(it), i[e2].setAttribute("aria-current", "true");
                    break;
                }
            }
        }
    ...
    class pt extends B {
        constructor(t, e){
            ...
            for(let t1 = 0, e1 = n.length; t1 < e1; t1++){
                const e1 = n[t1], s = i1(e1), o = V.find(s).filter((t)=>t === this._element
                );
                null !== s && o.length && (this._selector = s, this._triggerArray.push(e1));
            }
        ...
        hide() {
            ...
            for(let t2 = 0; t2 < e; t2++){
                const e = this._triggerArray[t2], i = n1(e);
        ...
        _initializeChildren() {
            ...
            const t = V.find(ut, this._config.parent);
            V.find(ft, this._config.parent).filter((e)=>!t.includes(e)
            ).forEach((t)=>{
                const e = n1(t);
    ...
    function de(t) {
        ...
        if (c) {
            ...
            w === Wt(i) && "static" !== Yt(w = Gt(i)).position && "absolute" === a && (E = "scrollHeight", A = "scrollWidth"), s !== mt && (s !== bt && s !== _t || o !== Et) || (v = gt, m -= w[E] - n.height, m *= l ? 1 : -1), s !== bt && (s !== mt && s !== gt || o !== Et) || (b = _t, f -= w[A] - n.width, f *= l ? 1 : -1);
        }
    ...
    class hi extends B {
        ...
        show() {
            ...
            this._inNavbar ? U.setDataAttribute(this._menu, "popper", "none") : this._createPopper(e), "ontouchstart" in document.documentElement && !e.closest(".navbar-nav") && [].concat(...document.body.children).forEach((t)=>j.on(t, "mouseover", d)
    ...
    class Hi extends B {
        ...
        hide() {
            ...
            t && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), this._focustrap.deactivate(), this._element.classList.remove(ji), j.off(this._element, Si), j.off(this._dialog, Ii), this._queueCallback(()=>this._hideModal()
            , this._element, t);
        }
        dispose() {
            [
    ...
    function Yi(t, e, i) {
        ...
        for(let t2 = 0, i2 = s.length; t2 < i2; t2++){
            const i2 = s[t2], n = i2.nodeName.toLowerCase();
            if (!Object.keys(e).includes(n)) {
                i2.remove();
                continue;
            }
            const o = [].concat(...i2.attributes), r = [].concat(e["*"] || [], e[n] || []);
            o.forEach((t)=>{
    ...
    class An extends B {
        constructor(t, e){
            super(t), this._scrollElement = "BODY" === this._element.tagName ? window : this._element, this._config = this._getConfig(e), this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, j.on(this._scrollElement, "scroll.bs.scrollspy", ()=>this._process()
        ...
        refresh() {
            ...
            this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), V.find(wn, this._config.target).map((t)=>{
                const s = i1(t), o = s ? V.findOne(s) : null;
                if (o) {
        ...
        _clear() {
            V.find(wn, this._config.target).filter((t)=>t.classList.contains(yn)
...
//# sourceMappingURL=articulo.dd0b785d.js.map
